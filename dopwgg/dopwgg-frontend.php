        ...
        class DOPWallGridGalleryFrontEnd{
            ...
            function addScripts(){
                ...
                if (preg_match('/MSIE 7/i', $_SERVER['HTTP_USER_AGENT'])){
                    wp_register_script('DOPWGG_json2', plugins_url('libraries/js/json2.js', __FILE__), array('jquery'), false, true);
                }
                wp_register_script('DOPWGG_MouseWheelJS', plugins_url('libraries/js/jquery.mousewheel.js', __FILE__), array('jquery'), false, true);
                wp_register_script('DOPWGG_JScrollPaneJS', plugins_url('libraries/js/jquery.jscrollpane.min.js', __FILE__), array('jquery'), false, true);
                wp_register_script('DOPWGG_WallGridGalleryJS', plugins_url('assets/js/jquery.dop.WallGridGallery.js', __FILE__), array('jquery'), false, true);
                ...
                if ($default_settings->data_parse_method == 'ajax'){
                    ...
                    foreach ($images as $image){
                        array_push($imagesList, '<li>
                                                    <img class="Image" src="'.DOPWGG_Plugin_URL.'uploads/'.$image->name.'" alt="'.stripslashes($image->title).'" title="'.stripslashes($image->title).'" />
                                                    <img class="Thumb" src="'.DOPWGG_Plugin_URL.'uploads/thumbs/'.$image->name.'" alt="'.stripslashes($image->title).'" title="'.stripslashes($image->title).'" />
                    ...
                    $data = '<div class="DOPWallGridGalleryContainer" id="DOPWallGridGallery'.$atts['id'].'">
                                 <a href="'.DOPWGG_Plugin_URL.'frontend-ajax.php" class="Settings"></a>
