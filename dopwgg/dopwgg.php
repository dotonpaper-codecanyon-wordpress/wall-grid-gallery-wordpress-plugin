...
// Paths
    ...
    if (!defined('DOPWGG_Plugin_URL')){
        define('DOPWGG_Plugin_URL', plugin_dir_url(__FILE__));
    }
    if (!defined('DOPWGG_Plugin_AbsPath')){
        define('DOPWGG_Plugin_AbsPath', str_replace('\\', '/', plugin_dir_path(__FILE__)));
    }
    ...
    if (is_admin()){// If admin is loged in admin init administration panel.
        ...
        if (!function_exists("DOPWallGridGalleryBackEnd_ap")){// Initialize the admin panel.
            function DOPWallGridGalleryBackEnd_ap(){
                ...
                if (function_exists('add_options_page')){
                    add_menu_page(DOPWGG_TITLE, DOPWGG_TITLE, 'edit_posts', 'dopwgg', array(&$DOPWGG_pluginSeries, 'printAdminPage'), 'div');
                }
            }
        }
        ...
        if (isset($DOPWGG_pluginSeries)){// Init AJAX functions.
            ...
            add_action('wp_ajax_dopwgg_edit_images', array(&$DOPWGG_pluginSeries, 'editImages'));
