...
$jDOPWGG(document).ready(function(){
    if (DOPWGG_curr_page == undefined){
        DOPWGG_curr_page = 'Galleries List';
    }
...
function dopwggResize(){// ResiE admin panel.
    ...
    $jDOPWGG('.column-input', '.DOPWGG-admin').width($jDOPWGG('.column-content', '.column3', '.DOPWGG-admin').width()-32);
...
function dopwggShowDefaultSettings(){// Show default settings.
    if (clearClick){
        ...
        $jDOPWGG.post(ajaxurl, {action: 'dopwgg_show_gallery_settings',
            ...
            HeaderHTML.push('<a href="javascript:void()" class="header-help"><span>'+DOPWGG_GALLERIES_EDIT_INFO_HELP+'</span></a>');
...
function dopwggShowGallerySettings(){// Show gallery settings.
    if (clearClick){
        ...
        $jDOPWGG.post(ajaxurl, {action: 'dopwgg_show_gallery_settings',
            ...
            HeaderHTML.push('<a href="javascript:void()" class="header-help last"><span>'+DOPWGG_GALLERY_EDIT_INFO_HELP+'</span></a>');
...
function dopwggEditGallerySettings(){// Edit Gallery Settings.
    if (clearClick){
        ...
        $jDOPWGG.post(ajaxurl, {action:'dopwgg_edit_gallery_settings',
                                ...
                                responsive_enabled: $jDOPWGG('#responsive_enabled').is(':checked') ? 'true':'false',                     
                                ...
                                social_share_enabled: $jDOPWGG('#social_share_enabled').is(':checked') ? 'true':'false',
            ...
            if ($jDOPWGG('#gallery_id').val() != '0'){
                $jDOPWGG('.name', '#DOPWGG-ID-'+$jDOPWGG('#gallery_id').val()).html(dopwggShortName($jDOPWGG('#name').val(), 25));
    ...
    if (clearClick){
        if (confirm(DOPWGG_EDIT_GALLERY_USE_DEFAULT_CONFIRMATION)){
            ...
            $jDOPWGG.post(ajaxurl, {action: 'dopwgg_show_gallery_settings',
                ...
                json['responsive_enabled'] == 'true' ? $jDOPWGG('#responsive_enabled').attr('checked', 'checked'):$jDOPWGG('#responsive_enabled').removeAttr('checked');
                ...
                json['social_share_enabled'] == 'true' ? $jDOPWGG('#social_share_enabled').attr('checked', 'checked'):$jDOPWGG('#social_share_enabled').removeAttr('checked');
                ...
                $jDOPWGG.post(ajaxurl, {action:'dopwgg_edit_gallery_settings',
                                        ...
                                        thumbnails_scroll_bar_color: $jDOPWGG('#thumbnails_scroll_bar_color').val(),
                                        thumbnails_info: $jDOPWGG('#thumbnails_info').val(),
                                        thumbnail_loader: json['thumbnail_loader'],
                                        thumbnail_width: $jDOPWGG('#thumbnail_width').val(),
                                        thumbnail_height: $jDOPWGG('#thumbnail_height').val(),
                                        thumbnail_width_mobile: $jDOPWGG('#thumbnail_width_mobile').val(),
                                        thumbnail_height_mobile: $jDOPWGG('#thumbnail_height_mobile').val(),
                                        ...
                                        lightbox_window_color: $jDOPWGG('#lightbox_window_color').val(),
                                        lightbox_window_alpha: $jDOPWGG('#lightbox_window_alpha').val(),
                                        lightbox_loader: json['lightbox_loader'],
                                        lightbox_bg_color: $jDOPWGG('#lightbox_bg_color').val(),
                                        lightbox_bg_alpha: $jDOPWGG('#lightbox_bg_alpha').val(),
                                        lightbox_margin_top: $jDOPWGG('#lightbox_margin_top').val(),
                                        lightbox_margin_right: $jDOPWGG('#lightbox_margin_right').val(),
...
function dopwggShowImages(gallery_id){// Show Images List.
    if (clearClick){
        ...
        $jDOPWGG.post(ajaxurl, {action:'dopwgg_show_images', gallery_id:gallery_id}, function(data){
            ...
            HeaderHTML.push('   <select name="DOPWGG-gallery-actions" id="DOPWGG-gallery-actions">');
            HeaderHTML.push('       <option value="">- '+DOPWGG_SELECT_ACTION+' -</option>');
            HeaderHTML.push('       <option value="delete">'+DOPWGG_DELETE+'</option>');
            HeaderHTML.push('       <option value="enable">'+DOPWGG_ENABLE+'</option>');
            HeaderHTML.push('       <option value="disable">'+DOPWGG_DISABLE+'</option>');
            HeaderHTML.push('   </select>');
            HeaderHTML.push('   <input type="button" name="DOPWGG_image_delete" class="submit-style" onclick="dopwggEditImages()" value="'+DOPWGG_APPLY+'">');
            HeaderHTML.push('</div>');
            HeaderHTML.push('<a href="javascript:void()" class="header-help"><span>'+DOPWGG_GALLERY_EDIT_HELP+'</span></a>');
...
function dopwggImagesEvents(){// Init Images Events.
    $jDOPWGG('.item-image', '.column2', '.DOPWGG-admin').each(function(){
        var id = $jDOPWGG(this).attr('id').split('-')[3];
        
        $jDOPWGG(this).prepend('<div class="checkbox-container"><input type="checkbox" name="DOPWGG-image-ID-check-'+id+'" id="DOPWGG-image-ID-check-'+id+'" /></div>');
    });
    
    $jDOPWGG('.DOPWGG-admin .column2 .item-image input').unbind('click');
    $jDOPWGG('.DOPWGG-admin .column2 .item-image input').bind('click', function(){
        clearClick = false;
    ...
    $jDOPWGG('.item-image', '.column2', '.DOPWGG-admin').unbind('click');
    $jDOPWGG('.item-image', '.column2', '.DOPWGG-admin').bind('click', function(){
        var id = $jDOPWGG(this).attr('id').split('-')[3];
...
function dopwggAddImages(){// Add Image/Images.
    if (clearClick){
        ...
        HeaderHTML.push('<a href="javascript:void()" class="header-help last"><span>'+DOPWGG_ADD_IMAGES_HELP+'</span></a>');
        ...
        uploadifyHTML.push('<a href="javascript:void()" class="header-help last"><span>'+DOPWGG_ADD_IMAGES_HELP_WP+'</span></a><br class="DOPWGG-clear" />');
        ...
        uploadifyHTML.push('    <a href="javascript:void()" class="header-help last"><span>'+DOPWGG_ADD_IMAGES_HELP_AJAX+'</span></a><br class="DOPWGG-clear" />');
        ...
        uploadifyHTML.push('<a href="javascript:void()" class="header-help last"><span>'+DOPWGG_ADD_IMAGES_HELP_UPLOADIFY+'</span></a><br class="DOPWGG-clear" />');  
        ...
        uploadifyHTML.push('<a href="javascript:void()" class="header-help last"><span>'+DOPWGG_ADD_IMAGES_HELP_FTP+'</span></a><br class="DOPWGG-clear" />');
        ...
        window.send_to_editor = function(html){
            ...
            $jDOPWGG.post(ajaxurl, {action:'dopwgg_add_image_wp', gallery_id:$jDOPWGG('#gallery_id').val(), image_url:$jDOPWGG('img', html).attr('src')}, function(data){
                ...
                $jDOPWGG('#DOPWGG-image-ID-'+imageID).prepend('<div class="checkbox-container"><input type="checkbox" name="DOPWGG-image-ID-check-'+imageID+'" id="DOPWGG-image-ID-check-'+imageID+'" /></div>');
                
                $jDOPWGG('#DOPWGG-image-ID-'+imageID+' input').unbind('click');
                $jDOPWGG('#DOPWGG-image-ID-'+imageID+' input').bind('click', function(){
                    clearClick = false;
                ...
                $jDOPWGG('#DOPWGG-image-ID-'+imageID).unbind('click');
                $jDOPWGG('#DOPWGG-image-ID-'+imageID).bind('click', function(){
                    var id = $jDOPWGG(this).attr('id').split('-')[3];
            ...
            'onComplete'     : function(event, ID, fileObj, response, data){                          
                                   if (response != '-1'){
                                       ...
                                       $jDOPWGG.post(ajaxurl, {action:'dopwgg_add_image', gallery_id:$jDOPWGG('#gallery_id').val(), name:response}, function(data){
                                           ...
                                           $jDOPWGG('#DOPWGG-image-ID-'+data).prepend('<div class="checkbox-container"><input type="checkbox" name="DOPWGG-image-ID-check-'+data+'" id="DOPWGG-image-ID-check-'+data+'" /></div>');

                                           $jDOPWGG('#DOPWGG-image-ID-'+data+' input').unbind('click');
                                           $jDOPWGG('#DOPWGG-image-ID-'+data+' input').bind('click', function(){
                                               clearClick = false;
                                           ...
                                           $jDOPWGG('#DOPWGG-image-ID-'+data).unbind('click');
                                           $jDOPWGG('#DOPWGG-image-ID-'+data).bind('click', function(){
                                               var id = $jDOPWGG(this).attr('id').split('-')[3];
...
function dopwggEditImages(){
    if (clearClick && $jDOPWGG('#DOPWGG-gallery-actions').val() != ''){
        var images = new Array(), i, noImages = 0,
        confirmationMessage, actionMessage;
        
        switch ($jDOPWGG('#DOPWGG-gallery-actions').val()){
            case 'delete':
                confirmationMessage = DOPWGG_DELETE_IMAGES_CONFIRMATION;
                actionMessage = DOPWGG_DELETE_IMAGES_SUBMITED;
                break;    
            case 'enable':
                confirmationMessage = DOPWGG_ENABLE_IMAGES_CONFIRMATION;
                actionMessage = DOPWGG_ENABLE_IMAGES_SUBMITED;
                break;
            case 'disable':
                confirmationMessage = DOPWGG_DISABLE_IMAGES_CONFIRMATION;
                actionMessage = DOPWGG_DISABLE_IMAGES_SUBMITED;
                break;
        }
        
        $jDOPWGG('.DOPWGG-admin .column2 li input').each(function(){
            var id = $jDOPWGG(this).attr('id').split('-')[4];

            if ($jDOPWGG('#DOPWGG-image-ID-check-'+id).is(':checked')){
                images.push(id);
            }
            noImages++;
        });
        ...
        if (images.length > 0 && confirm(confirmationMessage)){
            dopwggRemoveColumns(3);
            $jDOPWGG('li', '.column2', '.DOPWGG-admin').removeClass('item-image-selected');
            dopwggToggleMessage('show', actionMessage);

            $jDOPWGG.post(ajaxurl, {action: 'dopwgg_edit_images',
                                    images_action: $jDOPWGG('#DOPWGG-gallery-actions').val(),
                                    images: images}, function(data){
                switch ($jDOPWGG('#DOPWGG-gallery-actions').val()){
                    case 'delete':
                        for (i=0; i<images.length; i++){
                            $jDOPWGG('#DOPWGG-image-ID-check-'+images[i]).removeAttr('checked');
                            $jDOPWGG('#DOPWGG-image-ID-'+images[i]).animate({'opacity':0}, 600, function(){
                                $jDOPWGG(this).remove();
                                dopwggResize();
                            });
                        }
                        ...
                        dopwggToggleMessage('hide', DOPWGG_DELETE_IMAGES_SUCCESS);
                        break;    
                    case 'enable':
                        for (i=0; i<images.length; i++){
                            $jDOPWGG('#DOPWGG-image-ID-check-'+images[i]).removeAttr('checked');
                            $jDOPWGG('#DOPWGG-image-ID-'+images[i]).removeClass('item-image-disabled');
                        }
                        dopwggToggleMessage('hide', DOPWGG_ENABLE_IMAGES_SUCCESS);
                        break;
                    case 'disable':
                        for (i=0; i<images.length; i++){
                            $jDOPWGG('#DOPWGG-image-ID-check-'+images[i]).removeAttr('checked');
                            $jDOPWGG('#DOPWGG-image-ID-'+images[i]).addClass('item-image-disabled');
                        }
                        dopwggToggleMessage('hide', DOPWGG_DISABLE_IMAGES_SUCCESS);
                        break;
                }
        
                $jDOPWGG('#DOPWGG-gallery-actions option[value=""]').attr('selected', 'selected');
            });
        }
    }
}
...
function dopwggShowImage(id){// Show Image Details.
    if (clearClick){
        ...
        $jDOPWGG.post(ajaxurl, {action:'dopwgg_show_image', image_id:id}, function(data){            
            ...
            HeaderHTML.push('<a href="javascript:void()" class="header-help last"><span>'+DOPWGG_IMAGE_EDIT_HELP+'</span></a>');
...
// General Styles & Settings
    ...
    if ($jDOPWGG('#gallery_id').val() != '0'){
        ...
        HTML.push(dopwggSettingsFormSelect('data_parse_method', data['data_parse_method'], DOPWGG_DATA_PARSE_METHOD, '', '', '', 'help', DOPWGG_DATA_PARSE_METHOD_INFO, 'ajax;;html', 'AJAX;;HTML'));
    }
    ...
    HTML.push(dopwggSettingsFormSelect('images_order', data['images_order'], DOPWGG_IMAGES_ORDER, '', '', '', 'help', DOPWGG_IMAGES_ORDER_INFO, 'normal;;random', DOPWGG_FORM_NORMAL_TEXT+';;'+DOPWGG_FORM_RANDOM_TEXT));
    HTML.push(dopwggSettingFormSwitch('responsive_enabled', data['responsive_enabled'], DOPWGG_RESPONSIVE_ENABLED, '', '', 'help', DOPWGG_RESPONSIVE_ENABLED_INFO));
...
// Thumbnails Styles & Settings
    ...
    HTML.push(dopwggSettingsFormSelect('thumbnails_navigation', data['thumbnails_navigation'], DOPWGG_THUMBNAILS_NAVIGATION, '', '', '', 'help', DOPWGG_THUMBNAILS_NAVIGATION_INFO, 'mouse;;scroll', DOPWGG_FORM_MOUSE_TEXT+';;'+DOPWGG_FORM_SCROLL_TEXT));
    ...
    HTML.push(dopwggSettingsFormSelect('thumbnails_info', data['thumbnails_info'], DOPWGG_THUMBNAILS_INFO, '', '', '', 'help', DOPWGG_THUMBNAILS_INFO_INFO, 'none;;tooltip;;label', DOPWGG_FORM_NONE_TEXT+';;'+DOPWGG_FORM_TOOLTIP_TEXT+';;'+DOPWGG_FORM_LABEL_TEXT));
...
// Lightbox Styles & Settings
    ...
    HTML.push(dopwggSettingsFormSelect('lightbox_position', data['lightbox_position'], DOPWGG_LIGHTBOX_POSITION, '', '', '', 'help', DOPWGG_LIGHTBOX_POSITION_INFO, 'document;;gallery', DOPWGG_FORM_DOCUMENT_TEXT+';;'+DOPWGG_FORM_GALLERY_TEXT));
...
// Social Share Styles & Settings 
    ...
    HTML.push(dopwggSettingFormSwitch('social_share_enabled', data['social_share_enabled'], DOPWGG_SOCIAL_SHARE_ENABLED, '', '', 'help', DOPWGG_SOCIAL_SHARE_ENABLED_INFO));
...
// Label Styles & Settings
    ...
    HTML.push(dopwggSettingsFormSelect('label_position', data['label_position'], DOPWGG_LABEL_POSITION, '', '', '', 'help', DOPWGG_LABEL_POSITION_INFO, 'bottom;;top', DOPWGG_FORM_BOTTOM_TEXT+';;'+DOPWGG_FORM_TOP_TEXT));
    ...
    HTML.push('    .DOPWGG-admin .setting-box .switch-inner:before{content: "'+DOPWGG_FORM_ENABLED_TEXT+'";}');
    HTML.push('    .DOPWGG-admin .setting-box .switch-inner:after{content: "'+DOPWGG_FORM_DISABLED_TEXT+'";}');
    HTML.push('</style>');
...
function dopwggSettingsFormSelect(id, value, label, pre, suf, input_class, help_class, help, values, valuesLabels){// Create a Combo Box.
...
function dopwggSettingFormSwitch(id, value, label, pre, suf, help_class, help){ // Create a Switch Button
    ...
    switchtHTML.push('        <br class="DOPWGG-clear" />');
    switchtHTML.push('    </div>');
...
function dopwggShortName(name, size){// Return a short string.
