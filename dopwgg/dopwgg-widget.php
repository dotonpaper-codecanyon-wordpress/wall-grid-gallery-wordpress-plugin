...
*/
    ...
    class DOPWallGridGalleryWidget extends WP_Widget{
        ...
        function DOPWallGridGalleryWidget(){
            $widget_ops = array('classname' => 'DOPWallGridGalleryWidget', 'description' => !is_admin() ? '':DOPWGG_WIDGET_DESCRIPTION);
            $this->WP_Widget('DOPWallGridGalleryWidget', !is_admin() ? '':DOPWGG_WIDGET_TITLE, $widget_ops);
        }
